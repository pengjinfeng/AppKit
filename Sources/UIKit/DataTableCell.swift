...
open class DataTableCell: UITableViewCell ,TableCellProtocol{
    ...
    open func bind(data model: CellModelProtocol) {
        assert(false, "you must handel data in your cell")
    }
    
    open class func fetchHeight(cellModel model: CellModelProtocol) -> CGFloat {
